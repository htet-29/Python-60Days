...
add_button = sg.Button(size=20, image_source='add.png', tooltip='Add Todo', key='Add')
...
complete_button = sg.Button(size=20, image_source='complete.png', tooltip='Complete Todo', key='Complete')
